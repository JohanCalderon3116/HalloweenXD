    ...
    <Header>
      ...
      <section className="contentprincipal">
        ...
        <article className="contentlogo area2">
          ...
          <CctvBadge type="button" onClick={openCameras} title="Abrir monitor de cámaras CCTV FNAF">
            <span className="live-dot" />
            <span>CAM 1B: CAJA</span>
          </CctvBadge>
        </article>
...
const blinkRec = keyframes`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`;

const CctvBadge = styled.button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
